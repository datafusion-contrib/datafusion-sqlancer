        ...
        switch (type) {
            ...
            case FUNC_FIND_IN_SET:
                return DataFusionBaseExpr.createCommonStringFuncTwoStringArg("FIND_IN_SET",
                        Arrays.asList(DataFusionDataType.BIGINT, DataFusionDataType.DOUBLE));
            case FUNC_INITCAP:
                return DataFusionBaseExpr.createCommonStringFuncOneStringArg("INITCAP", Arrays.asList(DataFusionDataType.STRING));
            case FUNC_LOWER:
                return DataFusionBaseExpr.createCommonStringFuncOneStringArg("LOWER", Arrays.asList(DataFusionDataType.STRING));
            case FUNC_UPPER:
                return DataFusionBaseExpr.createCommonStringFuncOneStringArg("UPPER", Arrays.asList(DataFusionDataType.STRING));
            case FUNC_OCTET_LENGTH:
                return DataFusionBaseExpr.createCommonStringFuncOneStringArg("OCTET_LENGTH",
                        Arrays.asList(DataFusionDataType.BIGINT, DataFusionDataType.DOUBLE));
            case FUNC_BTRIM:
                return DataFusionBaseExpr.createCommonStringFuncOneStringArg("BTRIM", Arrays.asList(DataFusionDataType.STRING));
            case FUNC_BTRIM2:
                return DataFusionBaseExpr.createCommonStringFuncTwoStringArg("BTRIM", Arrays.asList(DataFusionDataType.STRING));
            case FUNC_TRIM:
                return DataFusionBaseExpr.createCommonStringFuncOneStringArg("TRIM", Arrays.asList(DataFusionDataType.STRING));
            case FUNC_TRIM2:
                return DataFusionBaseExpr.createCommonStringFuncTwoStringArg("TRIM", Arrays.asList(DataFusionDataType.STRING));
            case FUNC_LTRIM:
                return DataFusionBaseExpr.createCommonStringFuncOneStringArg("LTRIM", Arrays.asList(DataFusionDataType.STRING));
            case FUNC_LTRIM2:
                return DataFusionBaseExpr.createCommonStringFuncTwoStringArg("LTRIM", Arrays.asList(DataFusionDataType.STRING));
            case FUNC_RTRIM:
                return DataFusionBaseExpr.createCommonStringFuncOneStringArg("RTRIM", Arrays.asList(DataFusionDataType.STRING));
            case FUNC_RTRIM2:
                return DataFusionBaseExpr.createCommonStringFuncTwoStringArg("RTRIM", Arrays.asList(DataFusionDataType.STRING));
            case FUNC_LEFT:
            ...
            case FUNC_REPLACE:
                return new DataFusionBaseExpr("REPLACE", 3, DataFusionBaseExprCategory.FUNC,
                        ...
                        Arrays.asList(new ArgumentType.Fixed(new ArrayList<>(Arrays.asList(DataFusionDataType.STRING))),
                                ...
                                new ArgumentType.Fixed(new ArrayList<>(Arrays.asList(DataFusionDataType.STRING)))));
            case FUNC_REVERSE:
                return DataFusionBaseExpr.createCommonStringFuncOneStringArg("REVERSE", Arrays.asList(DataFusionDataType.STRING));
            ...
            case FUNC_SUBSTRING_INDEX:
                return new DataFusionBaseExpr("SUBSTRING_INDEX", 3, DataFusionBaseExprCategory.FUNC,
                        ...
                        Arrays.asList(new ArgumentType.Fixed(new ArrayList<>(Arrays.asList(DataFusionDataType.STRING))),
                                ...
                                new ArgumentType.Fixed(new ArrayList<>(Arrays.asList(DataFusionDataType.BIGINT)))));
            case FUNC_ENDS_WITH:
                return DataFusionBaseExpr.createCommonStringFuncTwoStringArg("ENDS_WITH", Arrays.asList(DataFusionDataType.BOOLEAN));
            case FUNC_STARTS_WITH:
                return DataFusionBaseExpr.createCommonStringFuncTwoStringArg("STARTS_WITH", Arrays.asList(DataFusionDataType.BOOLEAN));
            case FUNC_REGEXP_LIKE:
                return DataFusionBaseExpr.createCommonStringFuncTwoStringArg("REGEXP_LIKE", Arrays.asList(DataFusionDataType.BOOLEAN));
            ...
            case FUNC_REGEXP_MATCH:
                return DataFusionBaseExpr.createCommonStringFuncTwoStringArg("REGEXP_MATCH", Arrays.asList(DataFusionDataType.STRING)); // TODO(datafusion)
            // return
            // type
            // change
            // to
            ...
            case FUNC_REGEXP_REPLACE:
                return DataFusionBaseExpr.createCommonStringFuncTwoStringArg("REGEXP_REPLACE", Arrays.asList(DataFusionDataType.STRING));
