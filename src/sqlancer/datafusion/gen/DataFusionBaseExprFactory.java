...
public final class DataFusionBaseExprFactory {
    ...
    public static DataFusionBaseExpr createExpr(DataFusionBaseExprType type) {
        ...
        case LIKE:
            return createCommonStringOperatorTwoArgs(" LIKE ");
        case NOT_LIKE:
            return createCommonStringOperatorTwoArgs(" NOT LIKE ");
        case ILIKE:
            return createCommonStringOperatorTwoArgs(" ILIKE ");
        case NOT_ILIKE:
            return createCommonStringOperatorTwoArgs(" NOT ILIKE ");
        case REGEX_MATCH:
        ...
        case FUNC_ASCII:
            return createCommonStringFuncOneStringArg("ASCII",
                    Arrays.asList(DataFusionDataType.BIGINT, DataFusionDataType.DOUBLE));
        case FUNC_LENGTH:
            return createCommonStringFuncOneStringArg("LENGTH",
                    Arrays.asList(DataFusionDataType.BIGINT, DataFusionDataType.DOUBLE));
        case FUNC_CHAR_LENGTH:
            return createCommonStringFuncOneStringArg("CHAR_LENGTH",
                    Arrays.asList(DataFusionDataType.BIGINT, DataFusionDataType.DOUBLE));
        case FUNC_CHARACTER_LENGTH:
            return createCommonStringFuncOneStringArg("CHARACTER_LENGTH",
                    Arrays.asList(DataFusionDataType.BIGINT, DataFusionDataType.DOUBLE));
        case FUNC_BIT_LENGTH:
            return createCommonStringFuncOneStringArg("BIT_LENGTH",
                    Arrays.asList(DataFusionDataType.BIGINT, DataFusionDataType.DOUBLE));
        case FUNC_CHR:
            return new DataFusionBaseExpr("CHR", 1, DataFusionBaseExprCategory.FUNC,
                    ...
                    Arrays.asList(new ArgumentType.Fixed(new ArrayList<>(Arrays.asList(DataFusionDataType.BIGINT)))));
        case FUNC_INSTR:
            return createCommonStringFuncTwoStringArg("INSTR",
                    Arrays.asList(DataFusionDataType.BIGINT, DataFusionDataType.DOUBLE));
        case FUNC_STRPOS:
            return createCommonStringFuncTwoStringArg("STRPOS",
                    Arrays.asList(DataFusionDataType.BIGINT, DataFusionDataType.DOUBLE));
        case FUNC_LEVENSHTEIN:
            return createCommonStringFuncTwoStringArg("LEVENSHTEIN",
                    Arrays.asList(DataFusionDataType.BIGINT, DataFusionDataType.DOUBLE));
        case FUNC_FIND_IN_SET:
            return createCommonStringFuncTwoStringArg("FIND_IN_SET",
                    Arrays.asList(DataFusionDataType.BIGINT, DataFusionDataType.DOUBLE));
        case FUNC_INITCAP:
        ...
        case FUNC_OCTET_LENGTH:
            return createCommonStringFuncOneStringArg("OCTET_LENGTH",
                    Arrays.asList(DataFusionDataType.BIGINT, DataFusionDataType.DOUBLE));
        case FUNC_BTRIM:
        ...
        case FUNC_REGEXP_LIKE:
            return createCommonStringFuncTwoStringArg("REGEXP_LIKE", Arrays.asList(DataFusionDataType.BOOLEAN));
        ...
        case FUNC_REGEXP_MATCH:
            return createCommonStringFuncTwoStringArg("REGEXP_MATCH", Arrays.asList(DataFusionDataType.STRING)); // TODO(datafusion)
                                                                                                                 // return
                                                                                                                 // type
                                                                                                                 // change
                                                                                                                 // to
        ...
        case FUNC_REGEXP_REPLACE:
            return createCommonStringFuncTwoStringArg("REGEXP_REPLACE", Arrays.asList(DataFusionDataType.STRING));
